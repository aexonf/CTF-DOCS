...
```bash
┌─[✗]─[aexon@parrot]─[~]
└──╼ $sudo nmap -sCV -p- 10.10.10.15 --min-rate 1000 -Pn
[sudo] password for aexon: 
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-09-07 08:55 WIB
...
|   Server Date: Sat, 07 Sep 2024 01:55:07 GMT
...
di sini saya mengecek sebuah vuln yang ada di web nya, ternyata ada upload file webdav.
refrensi
...
ini exploit nya hampir sama seperti grandpa
